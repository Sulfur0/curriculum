...
<body>
		...
		<div class="w3-banner" id="banner">
			<div class="w3-banner-grid1">
				...
				<div class="col-md-4 w3-banner-right">
					<div class="w3-heading-all">
						<h3>{{__('Sobre')}} <span>{{__('Mí')}}</span></h3>
					</div>
				<div class=" w3ls-agile-left">
					<div class="w3ls-agile-left-info">
						<div class="wel-left animated wow fadeInLeft" data-wow-delay=".5s">
							...
							<div class="text-w3l web-dev">
								<h4>{{__('DESARROLLADOR WEB')}}</h4>
								<p>{{__('He Desarrollado Websites Para Múltiples Negocios en Diferentes Países, Aplicaciones Web Desplegadas en la Nube, Software como Servicio (SaaS) y Mucho Más.')}}</p>
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
					<div class="w3ls-agile-left-info">
						<div class="wel-left animated wow fadeInLeft" data-wow-delay=".5s">
							...
							<div class="text-w3l app-dev">
								<h4>{{__('DESARROLLADOR DE APLICACIONES PARA ESCRITORIO')}}</h4>
								<p>{{__('Como Ingeniero de Sistemas me especializo en el desarrollo de software de alto desempeño para aplicaciones científicas, control y automatización de equipamiento industrial, análisis de algoritmos y técnicas especializadas de programación, programación de sistemas expertos y todo tipo de SI.')}}</p>
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
			...
			<div class="w3-banner-grid2">
				...
				<div class="w3-banner_bottom2">
				  <div class="w3-banner_bottom_txt">
					<div class="w3-banner-bot_icon_icon">
				        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
				    </div>
				   <div class="w3-banner-bot_icon_txt">
				        <a class="book popup-with-zoom-anim button-isi zoomIn animated" data-wow-delay=".5s" href="#small-dialog1">WORKS</a>
		         </div>
				 <div class="clearfix"></div>
				  </div>
		
				</div>
				<div class="w3-banner_bottom3">
				  <div class="w3-banner_bottom_txt">
				 <div class="w3-banner-bot_icon_icon">
		...
		<div class="w3_head_pop">
			...
			<div class="w3layouts_gallery_grids">	
				<div class="col-md-3 w3layouts_gallery_grid">
					<img src="images/p1.jpg" alt="gallery">
					<a href="#" data-toggle="modal" data-target="#myModal">projects</a>

				</div>
				<div class="col-md-3 w3layouts_gallery_grid">
					<img src="images/p2.jpg" alt="gallery">
					<a href="#" data-toggle="modal" data-target="#myModal1">projects</a>
				</div>
				<div class="col-md-3 w3layouts_gallery_grid">
					<img src="images/p3.jpg" alt="gallery">
					<a href="#" data-toggle="modal" data-target="#myModal2">projects</a>
				</div>
				<div class="col-md-3 w3layouts_gallery_grid">
					<img src="images/p4.jpg" alt="gallery">
					<a href="#" data-toggle="modal" data-target="#myModal3">projects</a>
				</div>
				<div class="col-md-3 w3layouts_gallery_grid">
					<img src="images/p5.jpg" alt="gallery">
					<a href="#" data-toggle="modal" data-target="#myModal4">projects</a>
				</div>
				<div class="col-md-3 w3layouts_gallery_grid">
					<img src="images/p6.jpg" alt="gallery">
					<a href="#" data-toggle="modal" data-target="#myModal5">projects</a>
				</div>
				<div class="col-md-3 w3layouts_gallery_grid">
					<img src="images/p7.jpg" alt="gallery">
					<a href="#" data-toggle="modal" data-target="#myModal6">projects</a>
				</div>
				<div class="col-md-3 w3layouts_gallery_grid">
					<img src="images/p8.jpg" alt="gallery">
					<a href="#" data-toggle="modal" data-target="#myModal7">projects</a>
				</div>
				<div class="clearfix"> </div>
...
<footer>
	<div class="agileinfo-footer">
		<div class="container">
			...
			<p class="footer-w3l-te">Lorem ipsum dolor sit amet, Excepteur sint occaecat cupidatat non consectetur adipiscing elit.</p>
			<div class="social-wthree-icons bnragile-icons">
					<ul>
						<li><a href="#" class="fa fa-facebook icon icon-border facebook"> </a></li>
						<li><a href="#" class="fa fa-twitter icon icon-border twitter"> </a></li>
...
<!-- //gauge-meter -->	
    ...
    <script>
		...
		*/
		...
		/*llamada*/
		var isElementInView = Utils.isElementInView($('#banner'), false);
